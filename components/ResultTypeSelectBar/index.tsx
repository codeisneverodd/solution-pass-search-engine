...
type ResultTypeSelectBarProps<T extends React.ElementType> = {} & Component<T>;

export function ResultTypeSelectBar({ children, className, ...restProps }: ResultTypeSelectBarProps<'div'>) {
...
ResultTypeSelectBar.TypeCard = TypeCard;
...
ResultTypeSelectBar.Slider = Slider;
